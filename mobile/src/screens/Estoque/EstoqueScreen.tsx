                    ...
                    <View style={s.expandido}>
                      {hist && (
                        <View style={s.fluxoRow}>
                          ...
                          <View style={s.fluxoItem}>
                            <Text style={[s.fluxoVal, { fontWeight: '900' }, hist.precisaRevisao && { color: colors.warning }]}>{hist.fechamento}</Text>
                            <Text style={s.fluxoLabel}>{hist.precisaRevisao ? '⏳ Aguard. Admin' : 'Saldo atual'}</Text>
                          </View>
                        </View>
                      )}
