...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 11, fontWeight: '800', color: colors.textSub, textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 12, paddingLeft: 10, borderLeftWidth: 3, borderLeftColor: colors.primary },
  ...
  inputLarge: { backgroundColor: colors.surfaceAlt, borderRadius: 14, paddingHorizontal: 14, height: 84, fontSize: 42, fontWeight: '800', color: colors.primary, textAlign: 'center', borderWidth: 2, borderColor: colors.primary + '35' },
  unit: { textAlign: 'center', color: colors.primary, marginTop: 4, fontSize: 11, fontWeight: '700', letterSpacing: 1.2, textTransform: 'uppercase' },
  list: { maxHeight: 180 },
  prodItem: { paddingVertical: 11, paddingHorizontal: 13, borderRadius: 10, marginBottom: 5, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.surfaceAlt, borderWidth: 1, borderColor: colors.border },
  prodItemActive: { backgroundColor: colors.primary, borderColor: colors.primary, shadowColor: colors.primary, shadowOpacity: 0.3, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  prodName: { fontSize: 14, color: colors.text, fontWeight: '500' },
  badgeLocal: { fontSize: 10, fontWeight: '700' },
  tabs: { flexDirection: 'row', gap: 8 },
  tab: { flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: colors.surfaceAlt, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  tabActive: { backgroundColor: colors.primary, borderColor: colors.primary, shadowColor: colors.primary, shadowOpacity: 0.25, shadowRadius: 6, shadowOffset: { width: 0, height: 3 }, elevation: 3 },
  ...
  bannerCarga: { flexDirection: 'row', alignItems: 'flex-start', gap: 14, backgroundColor: '#EEF2FF', borderRadius: 16, padding: 16, borderWidth: 1.5, borderColor: '#C7D2FE', shadowColor: '#4338CA', shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
  bannerCargaIcon: { fontSize: 32, marginTop: 1 },
  bannerCargaTitulo: { fontSize: 14, fontWeight: '900', color: '#3730A3', letterSpacing: 0.2 },
  bannerCargaSub: { fontSize: 11, color: '#4338CA', marginTop: 3, lineHeight: 17, opacity: 0.85 },
